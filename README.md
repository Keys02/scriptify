# Scriptify
Scriptify automates the intial of creation of a bash script by creating the file, making it executable and then adding the shebang line. The file can be opened in your preferred editor on the fly when the file creation is successful.
